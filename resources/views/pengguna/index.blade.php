    ...
    <div class="container-fluid pt-3">
        ...
        <div class="w-100 p-2">
            <div class="text-right mb-2 pr-3">
                <a href="{{ route('pengguna.add_page') }}" class="btn btn-primary"><i class="fa fa-plus mr-1"></i><span
                ...
                @foreach($data as $v)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('pengguna.edit', ['id' => $v->id]) }}" class="btn btn-sm btn-warning btn-edit"
