...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
        <p class="font-weight-bold mb-0" style="font-size: 20px">Halaman Edit Siswa</p>
        <ol class="breadcrumb breadcrumb-transparent mb-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">Edit Siswa
            </li>
        </ol>
    </div>
    <div class="w-100 p-2">
                                ...
                                <form method="post" id="form-input">
                                        ...
                                        <div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="jenis_kelamin"
                                                       id="jenis_kelamin_pria" value="laki-laki" {{ $data->jenis_kelamin == 'laki-laki' ? 'checked' : '' }}>
                                                <label class="form-check-label" for="jenis_kelamin_pria">Laki -
                                                    Laki</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="jenis_kelamin"
                                                       id="jenis_kelamin_wanita" value="perempuan" {{ $data->jenis_kelamin == 'perempuan' ? 'checked' : '' }}>
                                    ...
                                    <div class="w-100 mb-2">
                                        ...
                                        <input type="date" class="form-control" id="tanggal_lahir"
                                               ...
                                               name="tanggal_lahir" value="{{ \Carbon\Carbon::parse($data->tanggal_lahir)->format('Y-m-d') }}">
                                    </div>
                                    <div class="w-100 mb-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" id="no_hp"
                                                   name="no_hp" aria-describedby="inputGroupPrepend" value="{{ $data->no_hp }}">
                                        </div>
                                    </div>
                                    <div class="w-100 mb-2">
                            ...
                            <div class="tab-pane fade pt-2" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <div class="w-100 mb-2">
                                    ...
                                    <input type="text" class="form-control" id="nis" placeholder="NIS"
                                           name="nis" form="form-input" value="{{ $data->nis }}">
                                </div>
                                {{--                                <div class="w-100 mb-2">--}}
                            ...
                            <div class="tab-pane fade pt-2" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                <div class="w-100 mb-2">
                                    ...
                                    <input type="text" class="form-control" id="ibu" placeholder="Nama Ibu Kandung"
                                           name="ibu" form="form-input" value="{{ $data->ibu }}">
                                </div>
                                <div class="w-100 mb-2">
                                    ...
                                    <input type="text" class="form-control" id="ayah" placeholder="Nama Ayah Kandung"
                                           name="ayah" form="form-input" value="{{ $data->ayah }}">
                                </div>
                                <div class="w-100 mb-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" id="no_hp_ortu"
                                               ...
                                               form="form-input" value="{{ $data->no_hp_ortu }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="status" id="status_aktif" value="1"
                                   {{ $data->status == "1" ? 'checked' : '' }} form="form-input">
                            <label class="form-check-label" for="status_aktif">
                                Aktif
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="status" id="status_non_aktif" value="0" form="form-input" {{ $data->status == "0" ? 'checked' : '' }}>
