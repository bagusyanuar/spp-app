...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xs-2 f-bold text-body-small" style="text-align: right;">: {{ number_format($data->nominal, 0, ',', '.') }}</div>
    </div>
    <hr style="margin-bottom: 5px; margin-top: 5px;">
    <div class="row">
        <div class="col-xs-8 f-bold report-header-sub-title" style="text-align: right;"></div>
        <div class="col-xs-3 f-bold text-body-small" style="text-align: center;">Wonogiri, {{ \Carbon\Carbon::parse($data->tanggal)->format('d F Y') }}</div>
    </div>
    <br>
    <br>
    <br>
